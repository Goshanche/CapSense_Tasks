...
module CapSense_P4_v7_0_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("069f9d37-2c98-43ef-acda-48662d4643a4/77715107-f8d5-47e5-a629-0fb83101ac6b"),
	...
	cy_psoc3_pins_v1_10
		#(.id("069f9d37-2c98-43ef-acda-48662d4643a4/7850aeaf-db25-4eae-b828-015ef596b59e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("bf490928-5c45-4dcc-8821-3ec31f7b4f9a"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__LED_User_status_net;
	wire [0:0] tmpFB_0__LED_User_status_net;
	wire [0:0] tmpIO_0__LED_User_status_net;
	wire [0:0] tmpINTERRUPT_0__LED_User_status_net;
	electrical [0:0] tmpSIOVREF__LED_User_status_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		LED_User_status
		 (.oe(tmpOE__LED_User_status_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_User_status_net[0:0]}),
		  .io({tmpIO_0__LED_User_status_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_User_status_net),
		  .interrupt({tmpINTERRUPT_0__LED_User_status_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_User_status_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__LED_CapSense_Button_0_net;
	wire [0:0] tmpFB_0__LED_CapSense_Button_0_net;
	wire [0:0] tmpIO_0__LED_CapSense_Button_0_net;
	wire [0:0] tmpINTERRUPT_0__LED_CapSense_Button_0_net;
	electrical [0:0] tmpSIOVREF__LED_CapSense_Button_0_net;

	cy_psoc3_pins_v1_10
		#(.id("f55861da-d6fc-4cc6-95db-5b67cfe9b7ec"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .ovt_slew_control(2'b00),
		  .input_buffer_sel(2'b00))
		LED_CapSense_Button_0
		 (.oe(tmpOE__LED_CapSense_Button_0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_CapSense_Button_0_net[0:0]}),
		  .io({tmpIO_0__LED_CapSense_Button_0_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_CapSense_Button_0_net),
		  .interrupt({tmpINTERRUPT_0__LED_CapSense_Button_0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_CapSense_Button_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_CapSense_Button_1_net;
	wire [0:0] tmpFB_0__LED_CapSense_Button_1_net;
	wire [0:0] tmpIO_0__LED_CapSense_Button_1_net;
	wire [0:0] tmpINTERRUPT_0__LED_CapSense_Button_1_net;
	electrical [0:0] tmpSIOVREF__LED_CapSense_Button_1_net;

	cy_psoc3_pins_v1_10
		#(.id("e8d1fd9a-e9fa-41ca-987f-d2777646a5aa"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .ovt_slew_control(2'b00),
		  .input_buffer_sel(2'b00))
		LED_CapSense_Button_1
		 (.oe(tmpOE__LED_CapSense_Button_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_CapSense_Button_1_net[0:0]}),
		  .io({tmpIO_0__LED_CapSense_Button_1_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_CapSense_Button_1_net),
		  .interrupt({tmpINTERRUPT_0__LED_CapSense_Button_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_CapSense_Button_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LED_CapSense_Button_2_net;
	wire [0:0] tmpFB_0__LED_CapSense_Button_2_net;
	wire [0:0] tmpIO_0__LED_CapSense_Button_2_net;
	wire [0:0] tmpINTERRUPT_0__LED_CapSense_Button_2_net;
	electrical [0:0] tmpSIOVREF__LED_CapSense_Button_2_net;

	cy_psoc3_pins_v1_10
		#(.id("9f4b41ae-7f39-403c-8753-d1612ee745c9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .ovt_slew_control(2'b00),
		  .input_buffer_sel(2'b00))
		LED_CapSense_Button_2
		 (.oe(tmpOE__LED_CapSense_Button_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LED_CapSense_Button_2_net[0:0]}),
		  .io({tmpIO_0__LED_CapSense_Button_2_net[0:0]}),
		  .siovref(tmpSIOVREF__LED_CapSense_Button_2_net),
		  .interrupt({tmpINTERRUPT_0__LED_CapSense_Button_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LED_CapSense_Button_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
